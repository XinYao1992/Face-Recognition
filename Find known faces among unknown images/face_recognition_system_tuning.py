...
# If an unknown image is too small to detect (or its revolution is low), then we should first find all face locations
# Then, pass face locations into face encoding functions to improve the accuracy.
# The variable called "number_of_times_to_upsample" is used to define the size of the image to scale up before we check
# for faces.
